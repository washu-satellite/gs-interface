...
const SEED_EVENTS: SeedEvent[] = [
    ...
    { id: "pl-2", kind: "planning", title: "Pass #131 pre-brief", start: 16 * 60 + 30, durationMin: 30, dayOffset: 3, detail: "Command sequence walkthrough" },
    { id: "mc-1", kind: "misc", title: "Team standup", start: 9 * 60, durationMin: 15, dayOffset: 1, detail: "Daily sync" },
